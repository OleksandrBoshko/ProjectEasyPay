...
public class SMSSender {
    private String SMSC_LOGIN    = "alexij";     // логин клиента
    private String SMSC_PASSWORD = "PaSsW0rd";  // пароль
    ...
    @Autowired
    public SMSSender(@Value("alexij") String login, @Value("PaSsW0rd") String password, @Value("utf-8") String charset,
                     @Value("true") boolean debug) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
        SMSC_CHARSET  = charset;
        SMSC_DEBUG    = debug;
...
/*
		...
		// or
		SMSSender sd= new SMSSender("login", "password");
